                                                            ...
                                                            <div className="note-record">
                                                                {
                                                                    ...
                                                                    <form onSubmit={handleEditSubmit}>
                                                                        <TextareaAutosize aria-label="minimum height" rowsMin={6} name = "noteRecord"onChange={handleEditChange} style={{ minWidth: 520, overflow: 'auto'}}>{note.noteRecord}</TextareaAutosize>
